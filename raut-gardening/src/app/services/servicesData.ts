...
export const ServicesData = [
    {
        title: ServicesEnum.BUNGALOW_DEVELOPMENT,
        description: 'Raut Ent specializes in designing and constructing exquisite bungalows that epitomize luxury and comfort. Our team of skilled architects and builders collaborates with clients to bring their dream homes to life, ensuring every detail is meticulously curated.',
        image: 'assets/hero.jpg'
    },
    {
        title: ServicesEnum.SWIMMING_POOL_INSTALLATION,
        description: 'Dive into opulence with our state-of-the-art swimming pool installations. From classic lap pools to resort-style oasis designs, we tailor each project to complement the surrounding landscape and meet the unique desires of our clients.',
        image: 'assets/pool-1.jpeg'
    },
    {
